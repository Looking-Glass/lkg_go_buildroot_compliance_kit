...
| **Build Configuration** | buildroot_ext/configs/<br>lookingglass_go_buildroot_toolchain_dev_no_proprietary_defconfig | The specific `config` file used for the system image excluding proprietary packages. |
